...
{% block fetch %}
https://gitlab.freedesktop.org/gstreamer/gstreamer/-/archive/1.20.3/gstreamer-1.20.3.tar.bz2
sha:2b74ca3aad12e87fcfe85e3f21f16353e3e7eebeaa89fe9bb5e2e9f58a3094ba
{% endblock %}
