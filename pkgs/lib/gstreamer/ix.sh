...
{% block fetch %}
https://gitlab.freedesktop.org/gstreamer/gstreamer/-/archive/1.22.3/gstreamer-1.22.3.tar.gz
sha:8f0db72a22a11527c01895b0aec50174f094c7c772369522350e03f24e87455a
{% endblock %}
