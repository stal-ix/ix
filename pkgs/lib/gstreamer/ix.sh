...
{% block fetch %}
https://gitlab.freedesktop.org/gstreamer/gstreamer/-/archive/1.24.9/gstreamer-1.24.9.tar.gz
sha:ec9483e7ecc59306923d797c0824e859013901ed520975cbbad5f46c9413a748
{% endblock %}
