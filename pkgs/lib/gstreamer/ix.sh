...
{% block fetch %}
https://gitlab.freedesktop.org/gstreamer/gstreamer/-/archive/1.22.5/gstreamer-1.22.5.tar.gz
sha:4da4bd28c41768035509f6d57dca989cdc29262d0b327b9fb5e6c45fccceacf5
{% endblock %}
