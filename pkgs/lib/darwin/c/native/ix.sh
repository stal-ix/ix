...
export OSX_SDK="{sdk}"
export CPPFLAGS="--sysroot ${OSX_SDK} -isystem${OSX_SDK}/usr/include -F${OSX_SDK} -isystem/Library/Developer/CommandLineTools/usr/lib/clang/13.0.0/include -isystem/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include ${CPPFLAGS}"
