...
lib/dl(dl_for=bin/jdk/7/libs,dl_lib=net)
lib/dl(dl_for=bin/jdk/7/libs,dl_lib=jvm)
lib/dl(dl_for=bin/jdk/7/libs,dl_lib=java)
lib/dl(dl_for=bin/jdk/7/libs,dl_lib=jsig)
lib/dl(dl_for=bin/jdk/7/libs,dl_lib=verify)
{% endblock %}
