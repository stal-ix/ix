...
etc/services/runit(srv_deps=bin/openssh/client,srv_dir=vpn_cz_common,srv_user=pg,srv_command=exec ssh -N -D 0.0.0.0:1082 -o StrictHostKeyChecking=no root@176.74.218.69)
etc/services/runit(srv_deps=bin/openssh/client,srv_dir=vpn_jopa_common,srv_user=pg,srv_command=exec ssh -N -D 0.0.0.0:1083 -i /home/pg/.ssh/ampere -o StrictHostKeyChecking=no mudak@45.11.171.78)
{% endblock %}
