...
set/ci/unwrap/mingw/w64(target=mingw-w64-x86_64,clang_ver=18)
...
set/ci/unwrap/darwin/arm64(target=darwin-arm64,clang_ver=18)
set/ci/unwrap/darwin/x86_64(target=darwin-x86_64,clang_ver=18)
{% endblock %}
