...
All packages are compiled as if host platform != target platform, thus, we achieve that the packet-base is built for all platforms most of the time. We have a cross-compiled autobuild for aarch64 and riscv!
